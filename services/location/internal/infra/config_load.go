...
func LoadConfig() Config {
	...
	cfg.CleanupEnabled = viper.GetBool("cleanup.enabled")
	cfg.CleanupIntervalSeconds = viper.GetInt("cleanup.interval_seconds")
	cfg.CleanupBatchSize = viper.GetInt("cleanup.batch_size")
