...
func TestUpdateDriverLocation(t *testing.T) {
	tests := []struct {
		...
		{"invalid_lat", nil, nil, false, 200, true},
		{"repo_error", errors.New("db"), nil, false, 1, true},
		{"publish_disabled", nil, nil, false, 1, false},
		{"publish_enabled", nil, nil, true, 1, false},
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.publishEnabled && !tt.expectErr {
