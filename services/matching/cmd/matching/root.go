...
func init() {
	...
	rootCmd.PersistentFlags().Int("matching.offer_retry_max", 3, "offer retries per ride")
	rootCmd.PersistentFlags().Int("matching.offer_retry_backoff_ms", 200, "offer retry backoff base in ms")
	rootCmd.PersistentFlags().Int("matching.offer_retry_max_backoff_ms", 1500, "offer retry max backoff in ms")
	rootCmd.PersistentFlags().Int("matching.candidate_ttl_seconds", 30, "candidate list TTL seconds")
	rootCmd.PersistentFlags().Int("matching.active_offer_ttl_seconds", 12, "active offer TTL seconds")
	rootCmd.PersistentFlags().Int("matching.cooldown_seconds", 20, "driver cooldown after decline seconds")
	rootCmd.PersistentFlags().Int("matching.lock_ttl_seconds", 15, "ride lock TTL seconds")
	rootCmd.PersistentFlags().Float64("matching.radius_step_meters", 1000, "radius expansion step in meters")
	rootCmd.PersistentFlags().Float64("matching.radius_max_meters", 5000, "max radius expansion in meters")
	rootCmd.PersistentFlags().Int("matching.max_offers", 5, "max offers before cancel")
	rootCmd.PersistentFlags().Float64("matching.avg_speed_kmh", 24, "assumed average speed for ETA")
	rootCmd.PersistentFlags().Int("matching.eta_jitter_ms", 200, "ETA jitter in ms for tie-breaking")
	...
	_ = viper.BindPFlag("matching.offer_retry_max", rootCmd.PersistentFlags().Lookup("matching.offer_retry_max"))
	_ = viper.BindPFlag("matching.offer_retry_backoff_ms", rootCmd.PersistentFlags().Lookup("matching.offer_retry_backoff_ms"))
	_ = viper.BindPFlag("matching.offer_retry_max_backoff_ms", rootCmd.PersistentFlags().Lookup("matching.offer_retry_max_backoff_ms"))
	_ = viper.BindPFlag("matching.candidate_ttl_seconds", rootCmd.PersistentFlags().Lookup("matching.candidate_ttl_seconds"))
	_ = viper.BindPFlag("matching.active_offer_ttl_seconds", rootCmd.PersistentFlags().Lookup("matching.active_offer_ttl_seconds"))
	_ = viper.BindPFlag("matching.cooldown_seconds", rootCmd.PersistentFlags().Lookup("matching.cooldown_seconds"))
	_ = viper.BindPFlag("matching.lock_ttl_seconds", rootCmd.PersistentFlags().Lookup("matching.lock_ttl_seconds"))
	_ = viper.BindPFlag("matching.radius_step_meters", rootCmd.PersistentFlags().Lookup("matching.radius_step_meters"))
	_ = viper.BindPFlag("matching.radius_max_meters", rootCmd.PersistentFlags().Lookup("matching.radius_max_meters"))
	_ = viper.BindPFlag("matching.max_offers", rootCmd.PersistentFlags().Lookup("matching.max_offers"))
	_ = viper.BindPFlag("matching.avg_speed_kmh", rootCmd.PersistentFlags().Lookup("matching.avg_speed_kmh"))
	_ = viper.BindPFlag("matching.eta_jitter_ms", rootCmd.PersistentFlags().Lookup("matching.eta_jitter_ms"))
