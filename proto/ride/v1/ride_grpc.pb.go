...
type RideServiceClient interface {
	...
	DeclineOffer(ctx context.Context, in *DeclineOfferRequest, opts ...grpc.CallOption) (*DeclineOfferResponse, error)
	// ExpireOffer marks a pending offer as expired.
	ExpireOffer(ctx context.Context, in *ExpireOfferRequest, opts ...grpc.CallOption) (*ExpireOfferResponse, error)
}
...
func (c *rideServiceClient) AcceptOffer(ctx context.Context, in *AcceptOfferRequest, opts ...grpc.CallOption) (*AcceptOfferResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *rideServiceClient) DeclineOffer(ctx context.Context, in *DeclineOfferRequest, opts ...grpc.CallOption) (*DeclineOfferResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeclineOfferResponse)
...
func (c *rideServiceClient) ExpireOffer(ctx context.Context, in *ExpireOfferRequest, opts ...grpc.CallOption) (*ExpireOfferResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ExpireOfferResponse)
...
type RideServiceServer interface {
	...
	// DeclineOffer marks a pending offer as declined.
	DeclineOffer(context.Context, *DeclineOfferRequest) (*DeclineOfferResponse, error)
	// ExpireOffer marks a pending offer as expired.
	ExpireOffer(context.Context, *ExpireOfferRequest) (*ExpireOfferResponse, error)
...
func (UnimplementedRideServiceServer) AcceptOffer(context.Context, *AcceptOfferRequest) (*AcceptOfferResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AcceptOffer not implemented")
}
func (UnimplementedRideServiceServer) DeclineOffer(context.Context, *DeclineOfferRequest) (*DeclineOfferResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeclineOffer not implemented")
}
func (UnimplementedRideServiceServer) ExpireOffer(context.Context, *ExpireOfferRequest) (*ExpireOfferResponse, error) {
...
func _RideService_AcceptOffer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RideServiceServer).AcceptOffer(ctx, req.(*AcceptOfferRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RideService_DeclineOffer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RideServiceServer).DeclineOffer(ctx, req.(*DeclineOfferRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RideService_ExpireOffer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RideServiceServer).ExpireOffer(ctx, req.(*ExpireOfferRequest))
	}
	return interceptor(ctx, in, info, handler)
}
